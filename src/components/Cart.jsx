          ...
          <div>
            <dl className=" space-y-1 px-2 py-4">
              <div className="flex items-center justify-between">
                <dt className="text-sm text-gray-800">Price ({cartItems?.items?.length} item)</dt>
                <dd className="text-sm font-medium text-gray-900">₹{(cartItems?.total)/100}</dd>
              </div>
              ...
              <div className="flex items-center justify-between py-4">
                ...
                <dd className="text-sm font-bold text-green-700">Free</dd>
              </div>
              <div className="flex items-center justify-between border-y border-dashed py-4 ">
                <dt className="text-base font-medium text-gray-900">Total Amount</dt>
                <dd className="text-base font-medium text-gray-900">₹{(cartItems?.total)/100}</dd>
